    ...
    <>
      ...
      <div className='container-fluid bg_gradient py-5'>
        <div className='row'>
          ...
          <div className='col-lg-3 col-sm-6 col-12 card_all'>
            <div className='card'>
          ...
          <div className='col-lg-3 col-sm-6 col-12 card_all'>
            <div className='card'>
              <div className='top_icon'><i className="cart_top_icon bi bi-emoji-smile"></i></div>
              <h2 className='h_text'>70%</h2>
              <div className='speciality'>Success Rate</div>
            </div>
          </div>
      ...
      <div className='container-fluid pt-5' id='about-us'>
        <div className='container welcome_section'>
          <h2 className='welcome_blue'>WELCOME TO SUNITA CHOUDHARY</h2>
          <p className='wel_para'>Dr. Sunita Choudhary is a Sr. Consultant Gynecologist & Obstetrician at Shalby Multi-Specialty Hospital, Jaipur. <span className='about_bold'>Dedicated and best gynecologist from 11+ years,</span> aiming to extend education and professional knowledge attained till now, towards curing and healing various ailments of human beings.</p>
          ...
          <p className='wel_para'>Her keen interest include advanced laparoscopic and hysteroscopic surgeries for Fibroid, Gynae OPD, antenatal OPD, Infertility, Tuboplasty, counseling and guidance to adolescent and PCOD and post-menopausal women regarding health issues. </p>
